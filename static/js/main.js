$(document).ready(function () {
  ...
  $.fn.startOver = function () {
    ...
    $("#conversation").empty();
    const text =
      "Welcome! I'm Medical Chatbot, but you can call me medchat. What symptoms are you currently experiencing? When you've entered all of your symptoms, please write '<b>Done</b>'. Make sure you enter as much symptoms as possible so the prediction can be as correct as possible.";
    $("#conversation").append(
